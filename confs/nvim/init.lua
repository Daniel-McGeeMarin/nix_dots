...
vim.opt.breakindent = true -- tabs on wrap
vim.opt.undofile = true
vim.opt.wrap = true
vim.opt.ignorecase = true
vim.opt.smartcase = true
vim.opt.signcolumn = "yes" -- thing to the left
vim.opt.timeoutlen = 300 -- How fast whickey should pop up
vim.opt.list = true
