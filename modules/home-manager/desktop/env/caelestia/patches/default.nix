...
#
# To add a patch:
#   1. Generate: diff -u original.qml modified.qml > modules/home-manager/desktop/env/caelestia/patches/my-feature.patch
...
#
# Usage in home.nix:
#   package = import ../../modules/home-manager/desktop/env/caelestia/patches {
